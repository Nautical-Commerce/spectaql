...
module.exports = function (query, variables, value) {
  
//  console.log("Debug: ", query, variables); // Debug line. Remove after testing.
...
//  const variablesQuery = variables ? `&variables=${encodeURIComponent(variables)}` : ""
  ...
  var url = `${serverUrl}?query=${encodeURIComponent(query)}`;
